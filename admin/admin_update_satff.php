...
<div class="modal fade" id="updateStaff_modal<?php echo $row['id']?>" tabindex="-1" aria-labelledby="updateStaffLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
		  	<div class="modal-header">
		    	<h1 class="modal-title fs-5" id="updateStaffLabel">Update Information</h1>
		  	...
		  	<form action="admin_function.php" method="POST">
			  	...
			  	<div class="modal-footer">
			    	...
			    	<button type="submit" name="btnUpdateStaff" class="btn btn-warning" style="color: #ffffff;"><i class="fa-solid fa-pen-to-square" style="color: #ffffff;"></i>&nbsp;Update</button>
		  		</div>
		  	</form>
		</div>
	</div>
